package HR_Assist.actiondriver;
...
import HR_Assist.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	 ...
	 * 
	 * @return: Boolean (True: If alert present, False: If no alert)
	 * 
	 */
	@Override
	...
	/*	String newImageString = "http://localhost:8080/job/HR_Assist/ws/HR_Assist/ScreenShots/" + filename + "_"
				+ dateName + ".png";*/
		return destination;
	}
	@Override
